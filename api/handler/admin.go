...
// Create Admin godoc
// @ID create_admin
// @Router /jaluzi/api/v1/admin [POST]
...
// GetByID Admin godoc
// @ID get_by_id_admin
// @Router /jaluzi/api/v1/admin/{id} [GET]
...
// GetList Admin godoc
// @ID get_list_admin
// @Router /jaluzi/api/v1/admin [GET]
...
// Delete Admin godoc
// @ID delete_admin
// @Router /jaluzi/api/v1/admin/{id} [DELETE]
...
// Update Admin godoc
// @ID update_admin
// @Router /jaluzi/api/v1/admin/{id} [PUT]
