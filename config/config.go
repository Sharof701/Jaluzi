...
func Load() Config {
	...
	// config.ServiceName = cast.ToString(getOrReturnDefaultValue("SERVICE_NAME", "jaluzi"))
	...
	config.PostgresDatabase = cast.ToString(getOrReturnDefaultValue("POSTGRES_DATABASE", "jaluzi"))
